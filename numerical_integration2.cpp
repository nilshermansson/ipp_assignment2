...
std::atomic<int> current_trapeze{0};
...
{   
    int assigned_trapeze = current_trapeze.fetch_add(1);
    ...
    double *output_index = (double*)args;
    *output_index = summed_area;
...
int main(int argc, char *argv[])
{
    ...
    {
        pthread_create(&thread_handle[i], NULL, calculate_partial_area, (void*)&thread_outputs[i]);
    }
